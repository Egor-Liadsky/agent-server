...
/// Записи долговременной памяти владельца, самые свежие первыми — слоистая
/// память вытесняет по `updated_at` (design.md, решение 5), поэтому порядок
/// уже готов под усечение по лимиту вызывающим кодом.
